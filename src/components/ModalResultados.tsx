...
import { X, Trophy, Users, Download, FileText, Target } from 'lucide-react';
...
const ModalResultados = ({ isOpen, onClose }: ModalResultadosProps) => {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[90vh] flex flex-col animate-scaleIn">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Resultados da Votação</h2>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition shadow-md hover:shadow-lg"
            >
              <Download size={20} />
              Gerar Relatório
            </button>
        ...
        {showEscolhaPDF && (
          <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl">
            <div className="absolute inset-0 bg-black/40 backdrop-blur-sm rounded-2xl" onClick={() => setShowEscolhaPDF(false)} />
            <div className="relative bg-white rounded-xl shadow-2xl p-6 max-w-md w-full m-4">
